...
if (orderHeader) {
    ...
    partyIdentification = delegator.findOne("PartyIdentification", [partyId : partyId, partyIdentificationTypeId : "COMPANY_REG_NO" ], false);
    if (partyIdentification) {
      context.companyRegNo = partyIdentification.idValue;
    }
