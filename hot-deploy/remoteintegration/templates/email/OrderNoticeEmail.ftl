...
${screens.render("component://remoteintegration/widget/OrderScreens.xml#orderheader")}
<br />
${screens.render("component://remoteintegration/widget/OrderScreens.xml#orderitems")}
<#else>
