...
import com.citizenme.integration.ofbiz.model.SalesOrderCancellation;
...
public class CancelSalesOrderResource {
  ...
  public Response execute(InputStream requestBodyStream) throws GenericTransactionException {
    ...
    try {
      ...
      SalesOrderCancellation orderCancellation = (SalesOrderCancellation) ofbizRequest.getRequestParameter();
      ...
      , "sendTo", orderCancellation.getBillingEmail()
